...
\begin{minipage}{\maincolumnwidth}%
	\small{
    	\begin{itemize}
        \item \textbf{Degree Focus Areas:} Embedded and Hosted Software Development, Mixed Signal Electronics, CAD Modelling for 3D Printing, PCB Design, HDL Design and FPGAs, Classical and Modern Control Theory IC Design. 
        \item \textbf{Language Proficiencies:} C/C++, Python, MATLAB, SystemVerilog, HTML/CSS/JavaScript.  
        \item \textbf{Environments/Frameworks:} Linux/Unix, Qt/PyQt, MicroPython, LAMP Stack Web Dev.
		\end{itemize}}%
\end{minipage}
...
{\customcvproject{Low-cost robotic platform for Python coding education}{Sept 2019 - June 2020}{University - 3rd Year Disertation Project}
  {\begin{itemize}
      ...
      \item Developed Python API for robust, intuitive control of motors, RGBLEDs, piezob buzzer, ultrasound distance sensor over bluetooth. 
...
{\customcvproject{Uni Light Opera Society Musical Director}{Oct 2019 - Feb 2021}
  {\begin{itemize}
    \item Led ~25 singers and 12 orchestra to produce a successful operatic stage production.
    \item Managed performer disagreements, orchestra and cast recruitment, planning and running weekly rehearsals.  
    \item Liaised with show directors to manage rehearsal time and guide the direction for the overall project.
  \end{itemize}
  }
}
